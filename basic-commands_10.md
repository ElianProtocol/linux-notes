Вот конспект этого этапа, оформленный для публикации на GitHub. Он содержит сжатую теорию, пошаговые команды и структуру для быстрого развертывания WordPress.
